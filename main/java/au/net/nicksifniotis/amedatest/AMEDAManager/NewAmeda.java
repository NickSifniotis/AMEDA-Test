 ...
 */
public class NewAmeda implements AMEDA
{
    ...
    public NewAmeda(Context context)
    {
        _parent = context;
        dataReceived = "";
    ...
    private void addMessage(String msg)
    {
        ...
        if (msg.length() > 8)
        {
            String result = msg.substring(0, 8);
            msg = msg.substring (8);
...
//                res = (BluetoothSocket) m.invoke(device, MY_UUID);
    ...
    {
        Toast.makeText(_parent, new StringBuilder(title)
...
//            _test_handler.sendMessageDelayed(m, delay);
    ...
    /**
     * Not implemented. Todo - remove this shitty thing from the interface
     * @return
     */
    @Override
