 ...
 */
public class OldBluetoothServiceImplementation implements BluetoothService {
    // Debugging
    private static final String TAG = "OldBluetoothServiceImplementation";
     ...
     */
    public OldBluetoothServiceImplementation(Handler handler) {
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            synchronized (OldBluetoothServiceImplementation.this) {
                mConnectThread = null;
            }
